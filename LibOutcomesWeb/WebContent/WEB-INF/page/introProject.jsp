...
<section id="lib-content">
    <div class="container text-center">
        ...
        <!-- 제목 -->
        <article class="section-title center">
            <h2>기대효과 <strong>Project</strong></h2>
            <div class="line">
                <hr>
            </div>
        ...
        <article class="row">
            ...
            <div class="col-md-4 content">
                ...
                <p>공공도서관 업무 개선 및 사업의 확장이 가능할 것이다. 이제 단순 수치만으로 도서관을 평가할 수는 없다. 지속적인 가치의 평가와 이용자 서비스의 
                                개발을 통해 지역사회와의 소통에 구심점으로 자리매김해야 할 것이다.</p>
            </div>
            
            <div class="col-md-4 content">
                <i class="fa fa-plane"></i>
                <h4><strong>문헌정보학계의 발전</strong></h4>
                <p>평가모델의 공유를 통한 문헌정보학계의 발전을 도모할 수 있을 것이다. 과거의 여러 연구를 통해 평가의 영역이 현재도 여러 문제점이 있으나 개선 및 새로운 지표의 
                                개발이 용이하지 않다는 것을 목도해 왔다. 따라서 본 연구를 통해 성과의 평가라는 새로운 화두를 던질 수 있을 것이다.</p>
            </div>
        </article>
        <!-- /.내용 -->
